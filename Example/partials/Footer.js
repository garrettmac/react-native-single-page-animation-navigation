...
marginLeft,
miniListAboveFooter,
miniListAboveFooterButtonOnPress,
    ...
    return  (
         <Swiper style={{margin:10,}} tabBarPosition={showTabBar?"overlayBottom":null} tabBarUnderlineStyle={showTabBar?{top:60,backgroundColor:"#d9991d"}:null}>
            ...
            <FooterSwipeableSection
                ...
                title={title}
                subTitle={subTitle}
                miniListAboveFooter={miniListAboveFooter}
                miniListAboveFooterButtonOnPress={miniListAboveFooterButtonOnPress}
